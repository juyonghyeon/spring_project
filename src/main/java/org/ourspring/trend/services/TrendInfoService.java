...
public class TrendInfoService {
        ...
        private final TrendCrawlingService collectService;
        ...
        public List<Trend> getList(String category, CommonSearch search) {
            ...
            List<Trend> data = repository.getPeriodTrend(category, sDate.atStartOfDay(), LocalDateTime.of(eDate, LocalTime.of(23, 59, 59)));
            return data;
        }
